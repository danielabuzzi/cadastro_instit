...
$sql = "INSERT INTO instituicao(nome,cnpj,tipo_inst,logradouro,cep,descri,quant_abrig,email,nome_resp,cpf) VALUES ('$nome','$cnpj','$tipo_inst','$logradouro','$cep','$descri','$quant_abrig','$email','$nome_resp','$cpf')";
